...
var IrcToSlack = require('./irc-to-slack');
var SlackBot = require('./slackbot');
var SlackRes = require('./slack-res');
var SlackToIrc = require('./slack-to-irc');
var NameMap = require('./name-map');
...
App.prototype._confirmReady = function(callback) {
  var checkingCycle = 0.1;
  var isReady = !_.isEmpty(this.slackRes.getUserMap()) && this.nameMap.isChecked;
  var isTimeout = this.config.initializeTimeoutLimit < this.confirmCounter;
