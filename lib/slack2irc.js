...
Slack2IRC.prototype.listen = function() {
  this._confirmReady(function() {
    this.config.slackAvatars = this.slackAvatars;
...
Slack2IRC.prototype._updateUserList = function() {
  request.get({
    ...
    res.members.map(function(member) {
      userList[member.id] = member.name;
      avatarList[member.name] = member.profile.image_48;
    });

    this.setUserList(userList);
    this.setAvatarList(avatarList);
  }.bind(this));
};
...
Slack2IRC.prototype.getAvatarList = function() {
  return this.slackAvatars;
};
...
Slack2IRC.prototype.setAvatarList = function(list) {
  this.slackAvatars = list;
};
